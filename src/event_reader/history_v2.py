...
def test_simple_2():
    ...
    everything = read_history([usdc, dai], approval + transfer, from_b, to_b, 250)
...
if __name__ == "__main__":
    ...
    stuff = [{"event": event_name, "abi": abi}]

    current = w3.eth.block_number
    logs = read_history(address, stuff, current - 100, current, 50)
    print(logs)
